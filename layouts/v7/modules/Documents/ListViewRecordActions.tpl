            ...
            <ul class="dropdown-menu">
                <li><a data-id="{$LISTVIEW_ENTRY->getId()}" href="{$LISTVIEW_ENTRY->getFullDetailViewUrl()}">{vtranslate('LBL_DETAILS', $MODULE)}</a></li>
                    {if $RECORD_ACTIONS}
                        ...
                        when record status approved and disapporved then remove edit and delete link*}
                        {if $RECORD_ACTIONS['edit'] && $LISTVIEW_ENTRY->checkRecordStatus($LISTVIEW_ENTRY->getId())}
                        ...
                        {/if}
                        {if $RECORD_ACTIONS['delete'] && $LISTVIEW_ENTRY->checkRecordStatus($LISTVIEW_ENTRY->getId())}
