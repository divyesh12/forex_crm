            ...
            <div class="btn-toolbar row">
                <div class="col-lg-6 col-md-6 col-sm-6 btn-toolbar">
                    <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                {*Remove By Divyesh - 13-09-2019
                                                Remove Extra Link from Add Document button*}
                        ...
                        {/foreach}
                        {if $MODULE eq 'Contacts' && $RELATED_MODULE_NAME eq 'Documents'}
                            <div class="col-sm-3" style="margin-left:10px;">
                            {if $KYC_ANSWER_BTN_ENABLE eq true}
                                <div class="btn-group">
                                    <button type="button" module="Documents" class="btn btn-default addButton" name="kyc_answer" id="kyc_answer_btn" data-url="index.php?module=Contacts&amp;view=KycAnswer&amp;&amp;returnrecord={$PARENT_ID}&amp;returnmodule=Contacts&amp;returnview=Detail&amp;returnrelatedModuleName=Documents&amp;returnrelationId=21&amp;contact_id={$PARENT_ID}&amp;app=MARKETING">
                                    <i class="fa fa-question-circle"></i>&nbsp;&nbsp;KYC Answers
                                    </button>
                                </div>
                            {/if}
                            </div>
                        ...
                        <tr class="listViewEntries" data-id='{$RELATED_RECORD->getId()}' 
                            ...
                            <td style="width:100px">&nbsp;&nbsp;&nbsp;
                                <span class="actionImages">
                                    {*Add By Divyesh- 16-09-2019
                                    When Document has been approved or disapproved then can't edit and delete record from related list
                                    *}
                                    {if $RELATED_RECORD->checkRecordStatus($RELATED_RECORD->getId())}
...
{literal}
    <script type="text/javascript">
        jQuery(function () {
            ...
            jQuery('#kyc_answer_btn').on('click', function (e) {
                var element = jQuery(e.currentTarget);
                var url = element.data('url');console.log(url);
