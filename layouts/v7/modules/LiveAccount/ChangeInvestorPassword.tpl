    ...
    <div id="massEditContainer" class="modal-dialog modelContainer">
        <div class="modal-header">
            <div class="clearfix">
                ...
                <h4 class="pull-left">{vtranslate('LBL_CHANGE_INVESTOR_PASSWORD', $MODULE)}</h4></div>
        </div>
        <div class="modal-content">
            <form class="form-horizontal" id="changePassword" name="changePassword" method="post" action="index.php" novalidate="novalidate">
                ...
                <input type="hidden" id="change_action" value="changeAccountInvestorPassword">

                {*<input  type="hidden" name="view" value="SavePassword">*}
                <div name="massEditContent">
                    <div class="modal-body ">
                        <div class="form-group"></div>
                        <div class="form-group">
                            <label class="control-label fieldLabel col-sm-5">{vtranslate('LBL_INVESTOR_PASSWORD', $MODULE)}<span class="redColor">*</span></label>
