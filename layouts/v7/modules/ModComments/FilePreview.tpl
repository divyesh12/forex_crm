                ...
                <div class="modal-body row" style="height:550px;">
                    ...
                    {else}
                        ...
                        {else if $OPENDOCUMENT_FILE_TYPE eq 'yes'}
                            {if $s3enable}
                                <iframe id="viewer" src="{$DOWNLOAD_URL}" width="100%" height="100%" allowfullscreen webkitallowfullscreen></iframe>
                            {else}
                        ...
                        {else if $PDF_FILE_TYPE eq 'yes'}
                            {if $s3enable}
                                <iframe id='viewer' src="{$DOWNLOAD_URL}" height="100%" width="100%"></iframe>
                            {else}
