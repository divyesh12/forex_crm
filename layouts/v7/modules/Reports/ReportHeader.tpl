    ...
    <div class="reportsDetailHeader">
        ...
        <form id="detailView" onSubmit="return false;">
            ...
            <div id="filterContainer" class="filterElements filterConditionsDiv {if $filterConditionNotExists eq true} hide {/if}">
                ...
                <div class="row">
                    <!-- change by Divyesh start -->
                    <div class="textAlignCenter reportActionButtons">
                        ...
                        {if (in_array($RECORD_ID, $customReportEmailids))}
                            <button class="btn btn-default emailReport" data-mode="sendemail" value="{vtranslate('Email Report',$MODULE)}"/>
                            <strong>{vtranslate('Email Report',$MODULE)}</strong>
                            </button>
                        {/if}
