...
jQuery.Class("Vtiger_Popup_Js",{
	...
	getCompleteParams : function(){
        ...
        //add by Divyesh Chothani 05-04-2020
        var parent_contactid = jQuery('input[name="contactid"]').val();
        if(this.getSourceModule() == 'CustomReports' && this.getSourceField() == 'child_contactid' && parent_contactid){
        	params['parent_contactid'] = parent_contactid;
        }
        if(this.getSourceModule() == 'CustomReports' && this.getSourceField() == 'liveaccountid' && parent_contactid){
			params['column1'] = 'contactid';
			params['value1'] =  parent_contactid;
