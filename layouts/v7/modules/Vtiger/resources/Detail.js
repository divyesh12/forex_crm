	...
	loadContents : function(url,data){
		...
		if(url.indexOf('index.php') < 0) {
			url = 'index.php?' + url;
                ...
                if(module === 'Campaigns' && postData.relatedModule === 'Emails')
                {
                    var campaign_activity_id = jQuery('#campaign_activity_list_of_email option:selected').val();
                    url = url + '&campaign_activity_id=' + campaign_activity_id;
                }
		var params = [];
		params.url = url;
