...
Vtiger_Date_Field_Js('AdvanceFilter_Date_Field_Js',{},{
	...
	getUi : function() {
		...
		if(comparatorSelectedOptionVal == 'bw' || comparatorSelectedOptionVal == 'custom'){
			var html = '<div class="date"><input class="inputElement dateField" style="width:261px;" data-calendar-type="range" name="'+ this.getName() +'" data-date-format="'+ this.getDateFormat() +'" type="text" value="'+  this.getValue() + '"></div>';
