...
{strip}
    ...
    <div class="col-lg-12">
        {*Changed By Reena 13-12-2019*}
            {*<div class="col-lg-12">*}
            {*Changed By Reena 03_06_20 for login box position change left side*}
          <div class="col-lg-5">
            {*end*}
        ...
        {*        Add by Reena add hide class 16-12-2019*}
        ...
        <div class="col-lg-5 hide">
            <div class="marketingDiv widgetHeight">
                {* Add By :- Reena Hingol
                *Date :- 13-12-2019
                *Comment :- Remove Advertisement from login page 
                *}
                {if $JSON_DATA}
