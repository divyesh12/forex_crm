...
-->*}
{strip}
    <div class="col-lg-8 detailViewButtoncontainer">
        <div class="pull-right btn-toolbar">
            <div class="btn-group">
            <button type="button" module="HelpDesk" class="btn btn-default addButton" name="addButton" data-url="{$TICKET_URL}">Add Ticket</button>
