...
jQuery.Class("Contacts_RelatedList_Js",{
	loaded : true,
	...
	getCompleteParams : function(){
		...
		if(this.relatedModulename == 'HelpDesk')
        {
            params['tab_label'] = 'HelpDesk';
            var helpTab = jQuery('[data-label-key=HelpDesk]');
            this.setSelectedTabElement(helpTab);
        }
		return params;
	},
