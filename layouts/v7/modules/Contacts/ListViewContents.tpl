                                ...
                                <span class="value">
                                    ...
                                    {else}
                                        ...
                                        {else}
                                            ...
                                            @Add By:- Divyesh
                                            @Date:- 20-02-2020
                                            @When IB Status not Approved then can't display affiliate code
                                            *}
                                            {if $LISTVIEW_HEADER->get('name') eq 'affiliate_code'}
                                                {if $LISTVIEW_ENTRY->isIBStatusApproved($LISTVIEW_ENTRY->getId()) eq 'Approved'}
                                                    {$LISTVIEW_ENTRY->get($LISTVIEW_HEADERNAME)}
                                                {/if}
                                            {else}
