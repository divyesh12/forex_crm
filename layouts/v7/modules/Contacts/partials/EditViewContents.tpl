...
{strip}
    ...
    <div name='editContent'>
        {*        /*Add By Reena 13_03_2020*/*}
        <input type="hidden" id="is_allow_update_parent_ib" value='{$IS_ALLOW_UPDATE_PARENT_IB}' />
        {*      END  *}
        <input type="hidden" id="is_allow_max_ib_comm" value='{$IS_ALLOW_MAX_IB_COMM}' />
