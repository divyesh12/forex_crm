...
Date:- 06-01-2020
Commnet :-  include CustomInputHiddenHTML.tpl file for hidden value line no 76
*}
{strip}
				...
				<form class="form-horizontal recordEditView" id="EditView" name="edit" method="post" action="index.php" enctype="multipart/form-data">
					...
					<div class="editViewBody">
						<div class="editViewContents">
							...
							{/if}
                                                        <!--Error msg-->
                                                        {if $ERROR_CUSTOM_MESSAGE}
                                                            <div class="fieldBlockContainer duplicationMessageContainer">
                                                                <div class="duplicationMessageHeader"><b>Error!</b></div>
                                                                <div>{$ERROR_CUSTOM_MESSAGE}</div>
                                                            </div>
                                                        {/if}
                                                        <!--Error msg-->
                                                        {include file="CustomInputHiddenHTML.tpl"|vtemplate_path:$MODULE} 
					...
					<div class='modal-overlay-footer clearfix'>
						<div class="row clearfix">
							<div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '>
								<button type='submit' class='btn btn-success saveButton disabled' >{vtranslate('LBL_SAVE', $MODULE)}</button>&nbsp;&nbsp;
