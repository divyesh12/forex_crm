                                    ...
                                    <table class="massEditTable table no-border">
                                          <tr>
                                                ...
                                                {foreach key=FIELD_NAME item=FIELD_MODEL from=$RECORD_STRUCTURE name=blockfields}
                                                      ...
                                                      {/if}
                                                      <td id="fieldLabel_{$FIELD_NAME}" class='fieldLabel col-lg-2 {$FIELD_NAME}'>
                                                      ...
                                                      {if $FIELD_MODEL->get('uitype') neq '83'}
                                                            <td id="fieldValue_{$FIELD_NAME}" class="fieldValue col-lg-4 {$FIELD_NAME}" {if $FIELD_MODEL->get('uitype') eq '19'} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}>
