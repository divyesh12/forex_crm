			...
			<div class="bottomscroll-div">
				<table id="listview-table" class="table listview-table">
					...
					{foreach item=RELATED_RECORD from=$RELATED_RECORDS}
                                                {assign var=SHOW_EDIT_DELETE_LINK value=$RELATED_RECORD->checkCampaignActivityStatus($RELATED_RECORD->getId())}
						<tr class="listViewEntries" data-id='{$RELATED_RECORD->getId()}' 
							...
							<td class="related-list-actions">
                                                            {if $SHOW_EDIT_DELETE_LINK}
								<span class="actionImages">&nbsp;&nbsp;&nbsp;
									{if $IS_EDITABLE && $RELATED_RECORD->isEditable()}
                                                                            <a name="relationEdit" data-url="{$RELATED_RECORD->getEditViewUrl()}"><i class="fa fa-pencil" title="{vtranslate('LBL_EDIT', $MODULE)}"></i></a> &nbsp;&nbsp;
									{/if}
							...
							{foreach item=HEADER_FIELD from=$RELATED_HEADERS}
								...
								<td class="relatedListEntryValues disabled" title="{strip_tags($RELATED_RECORD->getDisplayValue($RELATED_HEADERNAME))}" data-field-type="{$HEADER_FIELD->getFieldDataType()}" nowrap>
