...
class Mobile_APIV1_Controller {
	...
	Comment:- MobileAPI Changes For Add new Operation
	*/
	static $opControllers = array(
		...
		'describeModule'			=> array('file' => '/api/ws/DescribeModule.php',			'class' => 'Mobile_WS_DescribeModule'),
		'convertLead'				=> array('file' => '/api/ws/ConvertLead.php',			'class' => 'Mobile_WS_ConvertLead'),
		'changePortalPassword'		=> array('file' => '/api/ws/ChangePortalPassword.php',			'class' => 'Mobile_WS_ChangePortalPassword'),
		'resendPortalPassword'		=> array('file' => '/api/ws/ResendPortalPassword.php',			'class' => 'Mobile_WS_ResendPortalPassword'),
		'fetchCommentList'		    => array('file' => '/api/ws/CommentList.php',					'class' => 'Mobile_WS_CommentList'),
                'MainDashboard'		    => array('file' => '/api/ws/MainDashboard.php',					'class' => 'Mobile_WS_MainDashboard'),
        'changeTradingAndInvestorPassword'		=> array('file' => '/api/ws/ChangeTradingAndInvestorPassword.php',			'class' => 'Mobile_WS_ChangeTradingAndInvestorPassword'),
        'changeUserPassword'		=> array('file' => '/api/ws/ChangeUserPassword.php',			'class' => 'Mobile_WS_ChangeUserPassword'),
        'listChildIBCommProfile'		=> array('file' => '/api/ws/ListChildIBCommProfile.php',			'class' => 'Mobile_WS_ListChildIBCommProfile'),
	);
