...
$isCRMAppActive = configvar('is_crm_app_active');
if(!$isCRMAppActive)
{
	$errorMsg = "CRM mobile application is Inactive!";
	$result = array('success' => false, 'error' => array('code' => 1010,'message' => $errorMsg));
	header("Content-type:text/json;charset=UTF-8");
	echo json_encode($result);exit;
}

/*Check for subscription status */
subscriptionCRMHandler('json');
/*Check for subscription status */
...
if(!defined('MOBILE_API_CONTROLLER_AVOID_TRIGGER')) {
	...
	require_once dirname(__FILE__) . '/mobile.v1.php';
