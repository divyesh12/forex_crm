	...
	function process(Mobile_API_Request $request) {
		...
		try {
			if (vtws_recordExists($recordid)) {
				...
				/*Remove leverage value for vertex account*/
				if(in_array($module, array('LiveAccount', 'DemoAccount'))  && $values['request_from'] === 'Mobile')
				{
