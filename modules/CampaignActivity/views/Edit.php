...
Class CampaignActivity_Edit_View extends Vtiger_Index_View {
	...
	public function process(Vtiger_Request $request) {
		...
		if(!empty($record) && $request->get('isDuplicate') == true) {
			...
			$viewer->assign('MODE', 'edit');
                        $triggerTimeModel = CampaignActivity_Record_Model::getInstance($record);
			$viewer->assign('TRIGGER_TIME_MODEL_OBJ', $triggerTimeModel);
		} else {
		...
		if($isRelationOperation) {
			...
			$viewer->assign('SOURCE_RECORD', $request->get('sourceRecord'));
                ...
                $viewer->assign('PARENT_RECORD', $request->get('returnrecord'));
