...
//	var $listFields = array('summary' => 'Summary', 'module_name' => 'Module', 'execution_condition' => 'Execution Condition');
    ...
    static $metaVariables = array(
         ...
         * Date:- 05-11-2019
         * Comment:- Add Company Details for send mail workflow
         */
        'Company Name' => '(general : (__VtigerMeta__) companyName)',
        'Company Website' => '(general : (__VtigerMeta__) website)',
        'Company Address' => '(general : (__VtigerMeta__) address)',
        'Company City' => '(general : (__VtigerMeta__) city)',
        'Company State' => '(general : (__VtigerMeta__) state)',
        'Company Country' => '(general : (__VtigerMeta__) country)',
        'Company Phone' => '(general : (__VtigerMeta__) phone)',
        'Company Fax' => '(general : (__VtigerMeta__) fax)',
        'Current Year' => '(general : (__VtigerMeta__) currentYear)',
            /* End */
    );
