...
class Settings_ServiceProviders_Delete_Action extends Settings_Vtiger_Index_Action {
    ...
    public function process(Vtiger_Request $request) {
        ...
        if ($recordId) {
            $status = Settings_ServiceProviders_Module_Model::deleteRecords(array($recordId));
            if ($status) {
