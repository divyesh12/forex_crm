...
class Settings_ServiceProviders_ProviderField_Model extends Settings_ServiceProviders_Field_Model {
	...
	public static function getAll() {
		$providers = ServiceProviders_Provider_Model::getAll();
	...
	public static function getEditFieldTemplateName($providerName) {
		$providerInstance = ServiceProviders_Provider_Model::getInstance($providerName);
