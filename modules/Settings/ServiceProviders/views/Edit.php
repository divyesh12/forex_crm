...
class Settings_ServiceProviders_Edit_View extends Settings_Vtiger_IndexAjax_View {
    ...
    public function process(Vtiger_Request $request) {
        ...
        $viewer->assign('PROVIDERS_FIELD_MODELS', Settings_ServiceProviders_ProviderField_Model::getAll());
