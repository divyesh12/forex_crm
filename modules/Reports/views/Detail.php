...
class Reports_Detail_View extends Vtiger_Index_View {
	...
	function preProcess(Vtiger_Request $request, $display=true) {
		global $customReportids,$walletSummary_reportId,$openTrade_reportId,$closeTrade_reportId,$accoutTransaction_reportId,$ibStatistics_reportId,$ibSummary_reportId,$customReportEmailIds,$pendingIBCommissionAmount_reportId; //add by divyesh
		...
		$viewer->assign('walletSummary_reportId', $walletSummary_reportId);
		$viewer->assign('openTrade_reportId', $openTrade_reportId);
		$viewer->assign('closeTrade_reportId', $closeTrade_reportId);
		$viewer->assign('accoutTransaction_reportId', $accoutTransaction_reportId);
		$viewer->assign('ibStatistics_reportId', $ibStatistics_reportId);
		$viewer->assign('ibSummary_reportId', $ibSummary_reportId);
		$viewer->assign('customReportids', $customReportids);
		$viewer->assign('customReportEmailids', $customReportEmailIds);
		$viewer->assign('pendingIBCommissionAmount_reportId', $pendingIBCommissionAmount_reportId);
		//add by divyesh end
