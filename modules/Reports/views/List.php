...
class Reports_List_View extends Vtiger_Index_View {
	...
	function preProcess(Vtiger_Request $request, $display=true) {
		...
		global $customReportids,$walletSummary_reportId,$openTrade_reportId,$closeTrade_reportId,$accoutTransaction_reportId,$ibStatistics_reportId,$ibSummary_reportId,$pendingIBCommissionAmount_reportId; //add by divyesh
