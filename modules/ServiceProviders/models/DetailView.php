...
class ServiceProviders_DetailView_Model extends Vtiger_DetailView_Model {
    ...
    public function getDetailViewLinks($linkParams) {
        ...
        for ($i = 0; $i < $countOfList; $i++) {
            ...
            if ($linkModel->get('linklabel') == 'LBL_CHECK_STATUS') {
                $linkModelList['DETAILVIEW'][$i]->set('linklabel', vtranslate('LBL_CHECK_STATUS', 'ServiceProviders'));
