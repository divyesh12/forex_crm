...
interface ServiceProviders_ITradingPlatform_Model {

    //  const MSG_STATUS_DISPATCHED = 'Dispatched';

    const PROVIDER_TYPE = 1; // 1 for Trading Platform type
    const DEFAULT_REQUIRED_PARAMETERS = array(
        array('name' => 'leverage_enable', 'label' => 'Leverage Enable', 'type' => 'picklist', 'picklistvalues' => array('Yes' => 'Yes', 'No' => 'No'), 'mandatory' => true)
    );
