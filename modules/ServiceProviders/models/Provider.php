...
class ServiceProviders_Provider_Model extends Vtiger_Base_Model {

    /**
     * Function to get instance of provider model
     * @param <String> $providerName
     * @return <ServiceProviders_Provider_Model> provider object
     */
    public static function getInstance($providerName) {
        if (!empty($providerName)) {
            $providerName = trim($providerName);
            $className = Vtiger_Loader::getComponentClassName('Provider', $providerName, 'ServiceProviders');
