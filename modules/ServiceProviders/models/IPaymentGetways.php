...
/* @Add By Divyesh
 * @Date:- 15-11-2019
 * @Comment:-  Registor IPayment Getways functions
 */
vimport('~~/vtlib/Vtiger/Net/Client.php');

interface ServiceProviders_IPaymentGetways_Model {
    ...
    const DEFAULT_REQUIRED_PARAMETERS = array(
        ...
        array('name' => 'withdrawal_supported', 'label' => 'Withdrawal Supported', 'type' => 'picklist',
            'picklistvalues' => array('Yes' => 'Yes', 'No' => 'No'), 'mandatory' => true),
        array('name' => 'cabinet_deposit_supported', 'label' => 'Cabinet Deposit Supported', 'type' => 'picklist', 'picklistvalues' => array('Yes' => 'Yes', 'No' => 'No'), 'mandatory' => true),
        ...
        array('name' => 'deposit_processing_time', 'label' => 'Deposit Processing Time', 'type' => 'text', 'block' => self::TRANSFER_DETAILS_BLOCK, 'display_type' => 'Deposit', 'mandatory' => true),
        array('name' => 'withdrawal_processing_time', 'label' => 'Withdrawal Processing Time', 'type' => 'text', 'block' => self::TRANSFER_DETAILS_BLOCK, 'display_type' => 'Withdrawal', 'mandatory' => true),
        ...
        array('name' => 'withdrawal_allow_from', 'label' => 'Withdrawal allowed from', 'type' => 'picklist', 'picklistvalues' => array('Wallet' => 'Wallet', 'Account' => 'Account', 'WalletAccount' => 'WalletAccount')),
        array('name' => 'deposit_allow_from', 'label' => 'Deposit allowed from', 'type' => 'picklist', 'picklistvalues' => array('Wallet' => 'Wallet', 'Account' => 'Account', 'WalletAccount' => 'WalletAccount')),
