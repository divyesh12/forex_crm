...
class ServiceProviders_AgentTransfer_Provider extends ServiceProviders_AbstractPaymentGatways_Model {
    ...
    private static $REQUIRED_PARAMETERS = array(
        array('name' => 'bank_details', 'label' => 'Bank Details', 'type' => 'textarea', 'block' => self::OTHER_DETAILS_BLOCK, 'mandatory' => true),
        array('name' => 'bank_currency', 'label' => 'CAB_LBL_BANK_CURRENCY', 'type' => 'text', 'block' => self::TRANSFER_DETAILS_BLOCK, 'mandatory' => true),
        array('name' => 'currency_conversion', 'label' => 'Currency Conversion Tool', 'type' => 'picklist',
            'picklistvalues' => array('Yes' => 'Yes', 'No' => 'No'), 'mandatory' => true),
    );
    private static $DEPOSIT_FORM_PARAMETERS = array(
        array('name' => 'name', 'label' => 'LBL_CONTACT_NAME', 'type' => 'text', 'placeholder' => "", 'allow' => 'character', 'required' => true, 'mandatory' => true),
        array('name' => 'email', 'label' => 'CAB_LBL_EMAIL', 'type' => 'email', 'placeholder' => "", 'required' => true, 'mandatory' => true),
        array('name' => 'contact_number', 'label' => 'CAB_LBL_CONTACT_NUMBER', 'type' => 'number', 'placeholder' => "", 'required' => true, 'mandatory' => true),
    ...
    public function getName() {
        return 'AgentTransfer'; // don't take name with any space or special charctor
    }
