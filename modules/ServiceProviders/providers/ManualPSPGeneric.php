...
class ServiceProviders_ManualPSPGeneric_Provider extends ServiceProviders_AbstractPaymentGatways_Model
{
    ...
    private static $DEPOSIT_FORM_PARAMETERS = array(
        array('name' => 'email', 'label' => 'CAB_LBL_EMAIL', 'type' => 'email', 'placeholder' => "CAB_LBL_EMAIL", 'required' => true, 'mandatory' => true),
        array('name' => 'comment', 'label' => 'CAB_LBL_COMMENT', 'type' => 'text', 'placeholder' => "CAB_LBL_COMMENT"),
    ...
    {
        return 'ManualPSPGeneric'; // don't take name with any space or special charctor
    }
