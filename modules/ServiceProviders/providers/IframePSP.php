...
class ServiceProviders_IframePSP_Provider extends ServiceProviders_AbstractPaymentGatways_Model {
    ...
    private static $REQUIRED_PARAMETERS = array(
        array('name' => 'payment_link', 'label' => 'Payment Link', 'type' => 'text', 'mandatory' => true)
    );
    ...
    public function getName() {
        return 'IframePSP'; // don't take name with any space or special charctor
    }
