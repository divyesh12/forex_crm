...
class ServiceProviders_CryptoManual_Provider extends ServiceProviders_AbstractPaymentGatways_Model
{
    ...
    private static $REQUIRED_PARAMETERS = array(
        array('name' => 'file', 'label' => 'QR Code', 'type' => 'file', 'allowed_type' => "JPEG,JPG,PNG", 'block' => self::OTHER_DETAILS_BLOCK),
//        array('name' => 'client_qr_code', 'label' => 'QR Code', 'type' => 'text', 'value' => '/layouts/v7/modules/Settings/ServiceProviders/payments_logo/bitcoin_qr_code.png', 'block' => self::OTHER_DETAILS_BLOCK, 'mandatory' => true),
        array('name' => 'wallet_address', 'label' => 'Wallet Address', 'type' => 'textarea', 'block' => self::OTHER_DETAILS_BLOCK, 'mandatory' => true),
        array('name' => 'wallet_currency', 'label' => 'Wallet Currency', 'type' => 'text', 'block' => self::OTHER_DETAILS_BLOCK, 'mandatory' => true),
    );
    private static $DEPOSIT_FORM_PARAMETERS = array(
        array('name' => 'bitcoin_transaction_id', 'label' => 'CAB_LBL_TRANSACTION_HASH', 'type' => 'text', 'required' => true, 'mandatory' => true),
    ...
    private static $WITHDRAW_FORM_PARAMETERS = array(
        array('name' => 'wallet_address', 'label' => 'CAB_LBL_WALLET_ADDRESS', 'type' => 'text', 'required' => true, 'mandatory' => true),
    );
    ...
    {
        return 'CryptoManual'; // don't take name with any space or special charctor
    }
