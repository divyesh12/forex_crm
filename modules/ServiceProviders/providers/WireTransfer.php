...
class ServiceProviders_WireTransfer_Provider extends ServiceProviders_AbstractPaymentGatways_Model {
    ...
    public function getName() {
        return 'WireTransfer'; // don't take name with any space or special charctor
    }
