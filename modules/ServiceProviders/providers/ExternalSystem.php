...
class ServiceProviders_ExternalSystem_Provider extends ServiceProviders_AbstractPaymentGatways_Model {

    protected $module = 'Payments';
    protected $translate_module = 'CustomerPortal_Client'; // Common label file
    private static $REQUIRED_PARAMETERS = array(
//            array('name' => 'special_groups', 'label' => 'Special Groups', 'type' => 'text'),
    );
    ...
    public function getName() {
        return 'ExternalSystem'; // don't take name with any space or special charctor
    }
