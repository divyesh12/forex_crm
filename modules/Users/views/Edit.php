...
Class Users_Edit_View extends Users_PreferenceEdit_View {
	...
	public function preProcess(Vtiger_Request $request) {
        /* Add By Divyesh 
         * Comment:- Users Creation restriction base on subscription package contact
        */
		$recordId = $request->get('record');
        if (empty($recordId)) {
            $userCreationResult = usersCreationRestrictBaseOnPkg();
            $isEnableUserCreation = $userCreationResult['success'];
            $message = $userCreationResult['message'];
            if (!$isEnableUserCreation) {
