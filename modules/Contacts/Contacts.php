...
//End
    ...
    public static function getResendPortalEmailContents($entityData, $password, $type = '') {
        require_once 'config.inc.php';
        global $PORTAL_URL, $HELPDESK_SUPPORT_EMAIL_ID;
        ...
        $query = 'SELECT vtiger_emailtemplates.subject,vtiger_emailtemplates.body
					...
					WHERE vtiger_emailtemplates.templatename = "Resend Customer Portal Login Details"';
