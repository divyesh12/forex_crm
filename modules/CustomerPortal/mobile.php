...
subscriptionCabMobAppHandler('json');
/*Check for subscription status */
...
$response = CustomerPortal_API_EntryPoint::process(new CustomerPortal_API_Request($clientRequestValues, $clientRequestValuesRaw), $source);
