...
class Documents_InRelation_View extends Vtiger_RelatedList_View {
	...
	function process(Vtiger_Request $request) {
		...
		$kycAnswerBtnEnable = false;
		$kycAnswerEnable = configvar('is_kyc_questionnarie_enable');
		if($kycAnswerEnable != '')
		{
			$kycAnswerBtnEnable = true;
		}
		...
		$viewer->assign('KYC_ANSWER_BTN_ENABLE', $kycAnswerBtnEnable);
